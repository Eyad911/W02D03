...
const car2 = new cars("corola", 2018, "blue", "img", "BBB 544", 65000);
const car3 = new cars("BMW", 2014, "green", "img", "BBB 444", 63000);
const car4 = new cars("camray", 2012, "white", "img", "BBB 444", 63000);
const car5 = new cars("Rang Rover", 2017, "white", "img", "BBB 444", 66000);
